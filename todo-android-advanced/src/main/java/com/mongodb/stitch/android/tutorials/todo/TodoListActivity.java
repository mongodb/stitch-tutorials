...
public class TodoListActivity extends AppCompatActivity {
    ...
    public boolean onPrepareOptionsMenu(final Menu menu) {
        ...
        for (int i = 0; i < menu.size(); i++) {
            if (menu.getItem(i).getItemId() == R.id.login_action) {
                if (loggedIn) menu.getItem(i).setTitle("Log out");
                else menu.getItem(i).setTitle("Log in");
                continue;
            }
        }
        return true;
    ...
    private void showAddItemDialog() {
        ...
        @SuppressLint("InflateParams") final View view = getLayoutInflater().inflate(R.layout.edit_item_dialog, null);
